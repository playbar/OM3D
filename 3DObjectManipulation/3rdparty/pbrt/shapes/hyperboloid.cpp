...
Hyperboloid::Hyperboloid(const Transform *o2w, const Transform *w2o, bool ro,
        const PbrtPoint &point1, const PbrtPoint &point2, float tm)
    : Shape(o2w, w2o, ro) {
    p1 = point1;
    p2 = point2;
...
BBox Hyperboloid::ObjectBound() const {
    PbrtPoint p1 = PbrtPoint( -rmax, -rmax, zmin );
    PbrtPoint p2 = PbrtPoint(  rmax,  rmax, zmax );
    return BBox( p1, p2 );
}
...
Shape *CreateHyperboloidShape(const Transform *o2w, const Transform *w2o,
    ...
    PbrtPoint p1 = params.FindOnePoint("p1", PbrtPoint(0,0,0));
    PbrtPoint p2 = params.FindOnePoint("p2", PbrtPoint(1,1,1));
