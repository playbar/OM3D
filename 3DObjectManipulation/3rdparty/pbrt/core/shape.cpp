...
bool Shape::IntersectQ(const Ray &ray, float *tHit, float *rayEpsilon,
                      float* bs) const {
    Severe("Unimplemented Shape::IntersectQ() method called");
    return false;
}
...
float Shape::Pdf(const PbrtPoint &p, const Vector &wi) const {
