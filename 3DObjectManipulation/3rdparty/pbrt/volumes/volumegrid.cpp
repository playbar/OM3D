...
float VolumeGridDensity::Density(const PbrtPoint &Pobj) const {
...
VolumeGridDensity *CreateGridVolumeRegion(const Transform &volume2world,
    ...
    PbrtPoint p0 = params.FindOnePoint("p0", PbrtPoint(0,0,0));
    PbrtPoint p1 = params.FindOnePoint("p1", PbrtPoint(1,1,1));
    int nitems;
