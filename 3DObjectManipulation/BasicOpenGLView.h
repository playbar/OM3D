...
@interface BasicOpenGLView : NSOpenGLView
{
	...
	IBOutlet NSButton *btnLasso;
	IBOutlet NSButton *btnBBox;
	IBOutlet NSButton *btnPickPoints;
	IBOutlet NSButton *btnSave;
	IBOutlet NSButton *btnAxisRotate;
	IBOutlet NSButton *btnRevert;
	IBOutlet NSButton *btnRotate;
	IBOutlet NSButton *btnScale;
	IBOutlet NSButton *btnTranslate;
	IBOutlet NSButton *btnRender;
    IBOutlet NSButton *btnReplicate;
    IBOutlet NSButton *btnManipulate;
    IBOutlet NSButton *btnManipulate2;
