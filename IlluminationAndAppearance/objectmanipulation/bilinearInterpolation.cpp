...
{
    outputcolor->x=Itex[3*materialnums[shapeId]];
    outputcolor->y=Itex[3*materialnums[shapeId]+1];
    outputcolor->z=Itex[3*materialnums[shapeId]+2];
}
void getTexValImage(float* Itex, int* materialNumImage, int i, Vector* outputcolor)
{
    outputcolor->x=Itex[3*materialNumImage[i]];
    outputcolor->y=Itex[3*materialNumImage[i]+1];
    outputcolor->z=Itex[3*materialNumImage[i]+2];
}
