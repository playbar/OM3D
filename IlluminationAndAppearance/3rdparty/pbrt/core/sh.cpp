...
void SHProjectIncidentDirectRadiance(const PbrtPoint &p, float pEpsilon,
...
void SHComputeDiffuseTransfer(const PbrtPoint &p, const Normal &n,
...
void SHComputeBSDFMatrix(const Spectrum &Kd, const Spectrum &Ks,
    ...
    MemoryArena arena;
    DifferentialGeometry dg(PbrtPoint(0,0,0), Vector(1,0,0), Vector(0,1,0),
