...
struct InfiniteAreaCube {
    ...
    Spectrum operator()(int, int, const PbrtPoint &p, const Vector &w) {
...
void InfiniteAreaLight::SHProject(const PbrtPoint &p, float pEpsilon,
...
Spectrum InfiniteAreaLight::Sample_L(const PbrtPoint &p, float pEpsilon,
...
float InfiniteAreaLight::Pdf(const PbrtPoint &, const Vector &w) const {
...
Spectrum InfiniteAreaLight::Sample_L(const Scene *scene,
    ...
    *Ns = (Normal)d;
    ...
    PbrtPoint Pdisk = worldCenter + worldRadius * (d1 * v1 + d2 * v2);
