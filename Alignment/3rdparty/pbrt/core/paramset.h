...
public:
    ...
    void AddPoint(const string &, const PbrtPoint *, int nItems);
    ...
    PbrtPoint FindOnePoint(const string &, const PbrtPoint &d) const;
    ...
    const PbrtPoint *FindPoint(const string &, int *nItems) const;
...
private:
    ...
    vector<Reference<ParamSetItem<PbrtPoint> > > points;
...
public:
    ...
    PbrtPoint FindPoint(const string &n, const PbrtPoint &d) const {
