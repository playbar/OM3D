...
Spectrum VolumeRegion::sigma_t(const PbrtPoint &p, const Vector &w,
                               float time) const {
...
Spectrum AggregateVolume::sigma_a(const PbrtPoint &p, const Vector &w,
                                  float time) const {
    Spectrum s(0.);
    for (uint32_t i = 0; i < regions.size(); ++i)
...
Spectrum AggregateVolume::sigma_s(const PbrtPoint &p, const Vector &w, float time) const {
    Spectrum s(0.);
    for (uint32_t i = 0; i < regions.size(); ++i)
...
float AggregateVolume::p(const PbrtPoint &p, const Vector &w, const Vector &wp,
        float time) const {
    float ph = 0, sumWt = 0;
    for (uint32_t i = 0; i < regions.size(); ++i) {
...
Spectrum AggregateVolume::sigma_t(const PbrtPoint &p, const Vector &w, float time) const {
    Spectrum s(0.);
    for (uint32_t i = 0; i < regions.size(); ++i)
