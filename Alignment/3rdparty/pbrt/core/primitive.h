...
public:
	...
	virtual bool IntersectQ(const Ray &r, Intersection *in, float* barycentrics) const;
...
public:
	...
	virtual bool IntersectQ(const Ray &r, Intersection *isect, float* barycentrics) const;
...
public:
	...
	//bool IntersectQ(const Ray &r, Intersection *in, float* barycentrics) const;
